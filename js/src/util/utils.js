...
/**
 * Returns the client x in coordinates relative to the bounding element.
 * @param {Number} x The x client coordinates.
 * @param {*} boundingClientReact 
 * @returns The x coordinates relative to the bounding box.
 */
const toBoundingX = (x, boundingClientReact) => {
    return (x - boundingClientReact.left) * dpi;
}

/**
 * Returns the client y in coordinates relative to the bounding element.
 * @param {Number} y The y client coordinates.
 * @param {*} boundingClientReact 
 * @returns The y coordinates relative to the bounding box.
 */
const toBoundingY = (y, boundingClientReact) => {
    return (y - boundingClientReact.top) * dpi;
}